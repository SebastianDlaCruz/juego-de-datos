...
//int (int v[], int tam); /// Devuelve  la posici�n (primera) que ocupa el m�ximo en el vector.

int minimoVector(int v[], int tam); /// Devuelve  la posicion (primera) que ocupa el m�nimo en el vector.
...
int posicionNumeroEnVector(int v[],int tam, int numero); /// Dandole un n�mero busca la posici�n de dicho n�mero.


/// Desarrollo de funciones generales.


int ContarNumerosRepetidos(int V[], int Numero, int Tam){ //  Inicializa un contador luego 
    int Cant=0;
    for(int I=0;I<Tam;I++){
        if(V[I]==Numero) Cant++;
    }
